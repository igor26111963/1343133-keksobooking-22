...
import { avatar, price, rooms, guests, getRandomFeatures, getRandomPhotos } from './data.js';
import { coordinatesX, coordinatesY } from './address.js';
import { type, checkin, checkout } from './random-element.js';
